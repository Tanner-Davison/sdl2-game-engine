...
EditorToolbar::Defs() {
    static const std::array<ButtonDef, kButtonCount> kDefs = {{
        // Group 1 - Place tools
        {ButtonId::Goal,        Group::Place,    "Goal",     14, "1", true},
        {ButtonId::Enemy,       Group::Place,    "Enemy",    14, "2", true},
        {ButtonId::Tile,        Group::Place,    "Tile",     14, "3", true},
        {ButtonId::Erase,       Group::Place,    "Erase",    14, "4", true},
        {ButtonId::PlayerStart, Group::Place,    "Player",   14, "5", true},
        {ButtonId::Select,      Group::Place,    "Select",   13, "Q", true},
        {ButtonId::MoveCam,     Group::Place,    "Pan",      13, "T", true},
        // Group 2 - Modifier tools
        {ButtonId::Prop,        Group::Modifier, "Prop",     14, "8", true},
        {ButtonId::Ladder,      Group::Modifier, "Ladder",   14, "9", true},
        {ButtonId::Action,      Group::Modifier, "Action",   14, "0", true},
        {ButtonId::Slope,       Group::Modifier, "Slope",    14, "-", true},
        {ButtonId::Resize,      Group::Modifier, "Resize",   14, "R", true},
        {ButtonId::Hitbox,      Group::Modifier, "Hitbox",   14, "",  true},
        {ButtonId::Hazard,      Group::Modifier, "Hazard",   14, "",  true},
        ...
        {ButtonId::Save,        Group::Actions,  "Save",     14, "",  false},
        {ButtonId::Load,        Group::Actions,  "Load",     14, "",  false},
        {ButtonId::Clear,       Group::Actions,  "Clear",    14, "",  false},
        {ButtonId::Play,        Group::Actions,  "Play",     14, "",  false},
        {ButtonId::Back,        Group::Actions,  "< Menu",   14, "",  false},
    }};
    return kDefs;
}
